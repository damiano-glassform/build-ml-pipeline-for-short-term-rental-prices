...
def go(args):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        model_folder = os.path.join(temp_dir, "random_forest_dir")
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # First we impute the missing review date with an old date (because there hasn't
    # been a review for a long time), and then we create a new feature from it,
